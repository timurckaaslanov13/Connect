...
export function useConnect(){
 ...
 const[viewedUser,setViewedUser]=useState<number|null>(null)
 ...
 const logout=useCallback(()=>{setViewedUser(null);setToken('');changeToken('');setAccount(null);setProfile(null);setChats([]);setFriends([]);setSummaries([]);setActiveChat(null);setMessages([]);setPage('home')},[])
